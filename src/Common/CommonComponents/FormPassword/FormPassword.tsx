        ...
        return (
            <>
                <section className={styles.registration_fill_field}>
                    <div>
                        <label style={{visibility: email ? 'visible' : 'hidden'}}>Email</label>
                ...
                <section className={styles.registration_fill_field}>
                    <div>
                        <label style={{visibility: password ? 'visible' : 'hidden'}}>Password</label>
                        <input type={isVisible ? 'text' : 'password'} value={password} onChange={changePassword}
