...
export const WordModal: React.FC<WordModalType> = ({handlerIsModal}) => {
    ...
    const handlerAddNewWord = () => {
        ...
        dispatch(fetchAddWord({word: wordTrim, translate: translateTrim, description: descriptionTrim, added}))
        handlerIsModal()
    }
    return (
        <div className='container_modalWord' onClick={handlerIsModal}>
            <div onClick={(e) => e.stopPropagation()}>
                ...
                <div className={hint === 'word' ? 'modalWord_requiredfield' : ''}>
                    ...
                    <input autoFocus={true} type='text' placeholder={'Word'} value={word} onChange={handlerWord}/>
                </div>
